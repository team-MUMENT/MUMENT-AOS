...
class UserLikeMumentListAdapter: ListAdapter<UserEntity, UserLikeMumentListAdapter.UserLikeMumentListViewHolder>(
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemUserLikeMumentBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class UserLikeMumentListViewHolder(val binding: ItemUserLikeMumentBinding): RecyclerView.ViewHolder(binding.root)
}