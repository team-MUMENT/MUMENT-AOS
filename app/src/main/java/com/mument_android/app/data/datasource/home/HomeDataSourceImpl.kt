...
class HomeDataSourceImpl @Inject constructor(val service: HomeService) : HomeDataSource {
    override suspend fun getBannerMument(): BaseResponse<List<BannerMumentDto>> =
    ...
    override suspend fun getKnownMument(): BaseResponse<List<KnownMumentDto>> =
        service.getKnownMument()

    override suspend fun getRandomMument(): BaseResponse<List<RandomMumentDto>> =
